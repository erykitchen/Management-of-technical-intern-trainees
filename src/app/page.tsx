...
import { 
  ...
  nationalityOptions, statusOptions, acceptanceOptions, 
  genderOptions, batchColorMap, initialCompanyForm, initialTraineeForm 
} from './lib/constants';

import { 
  convertToAD, checkAlert, calculateAge, calculateDates 
} from './lib/utils';
