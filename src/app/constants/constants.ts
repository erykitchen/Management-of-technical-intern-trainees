...
export const statusOptions = ["選択する", "認定申請準備中", "認定手続中", "ビザ申請中", "入国待機", "入国後講習中", "実習中", "一時帰国中", "その他", "失踪"];
export const assigneeOptions = ["", "朝比奈", "政所"];
export const todoCategoryOptions = ["TODO", "支払関係", "試験関係"];
...
export const colors = { main: '#FFF9F0', accent: '#F57C00', text: '#2C3E50', gray: '#95A5A6', lightGray: '#F2F2F2', border: '#E0E0E0', white: '#FFFFFF', danger: '#E74C3C', info: '#3498DB' };